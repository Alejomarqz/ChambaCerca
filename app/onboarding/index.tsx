      ...
      <View style={styles.inner}>
        ...
        <View style={styles.featuresCard}>
          <Feature
            ...
            subtitle="Personas de tu zona que necesitan lo que tú sabes hacer"
          />
          <View style={styles.divider} />
          <Feature
            icon="person-add-outline"
            title="Crea tu perfil"
            subtitle="Di qué haces y permite que te contacten cuando lo necesiten"
          />
          <View style={styles.divider} />
          <Feature
            icon="people-outline"
